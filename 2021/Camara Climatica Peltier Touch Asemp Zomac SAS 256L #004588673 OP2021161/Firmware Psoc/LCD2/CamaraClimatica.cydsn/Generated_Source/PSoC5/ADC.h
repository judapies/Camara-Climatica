...
/* Default Config
* ADC_CFG1 Sample Rate: 160 Samples per Second
...
* ADC_CFG1 Clock: 2686880 Hz
*/

#define ADC_CFG1_DEC_CR             (0x7Cu)
...
#define ADC_CFG1_CLOCKS_PER_SAMPLE  (0x4199u)
#define ADC_CFG1_CLOCK_FREQ         (2686880u)
#define ADC_CFG1_CP_CLOCK_FREQ      (10747520u)
...
/* Second Config
* ADC_CFG2 Sample Rate: 46 Samples per Second
* ADC_CFG2 Conversion Mode: 1
* ADC_CFG2 Input Buffer Gain: 1
* ADC_CFG2 Reference: 0
* ADC_CFG2 Input Range: 4
* ADC_CFG2 Resolution: 20 bits
* ADC_CFG2 Clock: 3032320 Hz
*/

#define ADC_CFG2_DEC_CR             (0x74u)
...
#define ADC_CFG2_SRATE              (46u )
#define ADC_CFG2_CLOCKS_PER_SAMPLE  (0x10180u)
#define ADC_CFG2_CLOCK_FREQ         (3032320u)
#define ADC_CFG2_CP_CLOCK_FREQ      (12129280u)
#define ADC_CFG2_REFERENCE_VOLTAGE  (1.0240)
#define ADC_CFG2_COUNTS_PER_VOLT    (512000)
#define ADC_CFG2_RESOLUTION         (20u)
#define ADC_CFG2_CONV_MODE          (1u)
...
#define ADC_CFG2_ADC_CLK_DIVIDER    (16u)
#define ADC_CFG2_CP_CLK_DIVIDER     (3u)
...
#define ADC_CFG3_ADC_CLK_DIVIDER    (74u)
...
#define ADC_CFG4_ADC_CLK_DIVIDER    (74u)

...
CY_ISR(SPI0_TX_ISR)
{
    ...
    #ifdef SPI0_TX_ISR_ENTRY_CALLBACK
        SPI0_TX_ISR_EntryCallback();
    #endif /* SPI0_TX_ISR_ENTRY_CALLBACK */
    ...
    #ifdef SPI0_TX_ISR_EXIT_CALLBACK
        SPI0_TX_ISR_ExitCallback();
    #endif /* SPI0_TX_ISR_EXIT_CALLBACK */
}
...
CY_ISR(SPI0_RX_ISR)
{
    ...
    #ifdef SPI0_RX_ISR_ENTRY_CALLBACK
        SPI0_RX_ISR_EntryCallback();
    #endif /* SPI0_RX_ISR_ENTRY_CALLBACK */
    ...
    #ifdef SPI0_RX_ISR_EXIT_CALLBACK
        SPI0_RX_ISR_ExitCallback();
    #endif /* SPI0_RX_ISR_EXIT_CALLBACK */
}

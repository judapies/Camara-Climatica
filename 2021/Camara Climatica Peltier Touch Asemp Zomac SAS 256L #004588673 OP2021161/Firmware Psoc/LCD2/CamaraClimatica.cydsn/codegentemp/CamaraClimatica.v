...
module UART_v2_50_3 (
	...
	cy_clock_v1_0
		#(.id("94dcc601-6477-4fc8-8fc8-c96ee4485513/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1085069444.44444"),
		  .is_direct(0),
...
// ADC_SAR_SEQ_v2_10(ADC_Clock_Frequency=1600000, Adjust=0, ClockSource=0, InputRange=1, NumChannels=3, Reference=0, Resolution=12, rm_int=false, SampleMode=0, SamplePrecharge=4, SampleRate=100000, SampleRate_def=631579, VrefValue=2.5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_SEQ_v2_10, CY_CONFIG_TITLE=ADC_SAR, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR, CY_INSTANCE_SHORT_NAME=ADC_SAR, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=ADC_SAR, )
module ADC_SAR_SEQ_v2_10_9 (
    aclk,
    AIN_10,
    AIN_100,
    AIN_101,
	...
	cy_clock_v1_0
		#(.id("e68c442a-7559-4c5f-8943-71bb629a5253/9725d809-97e7-404e-b621-dfdbe78d0ca9"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("e68c442a-7559-4c5f-8943-71bb629a5253/3d23b625-9a71-4c05-baf4-2f904356009b"),
		  .source_clock_id("75C2148C-3656-4d8a-846D-0CAE99AB6FF7"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
...
module top ;
	...
	wire [0:0] tmpOE__SSR_2_net;
	wire [0:0] tmpFB_0__SSR_2_net;
	wire [0:0] tmpIO_0__SSR_2_net;
	wire [0:0] tmpINTERRUPT_0__SSR_2_net;
	electrical [0:0] tmpSIOVREF__SSR_2_net;
	...
	cy_psoc3_pins_v1_10
		...
		SSR_2
		 (.oe(tmpOE__SSR_2_net),
		  .y({Net_1610}),
		  .fb({tmpFB_0__SSR_2_net[0:0]}),
		  .io({tmpIO_0__SSR_2_net[0:0]}),
		  .siovref(tmpSIOVREF__SSR_2_net),
		  .interrupt({tmpINTERRUPT_0__SSR_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SSR_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    UART_v2_50_3 UART_2 (
        ...
        .rx_clk(Net_1229),
        .rx_data(Net_1230),
        .rx_interrupt(Net_1231),
        .tx(Net_1232),
        .tx_clk(Net_1233),
        .tx_data(Net_1234),
        .tx_en(Net_1235),
        .tx_interrupt(Net_1236));
	...
	cy_psoc3_pins_v1_10
		#(.id("730e2320-4a58-49ba-810e-e9a897a3efbd"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("63405911-2a5c-419c-aadd-7678348d643e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("63283f85-e2f6-48d3-b793-4df4becaf063"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("11884f99-0531-45ff-a8fc-1cb115df5aea"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    SPI_Master_v2_50_7 SPI0 (
        .clock(1'b0),
        .miso(Net_19),
        .mosi(Net_23),
        .reset(1'b0),
        .rx_interrupt(Net_1218),
        .sclk(Net_25),
        .sdat(Net_1219),
        .ss(Net_1),
        .tx_interrupt(Net_1220));
	...
	cy_clock_v1_0
		#(.id("28d49ded-aacf-4fb0-8d2b-d23717997126"),
		  .source_clock_id("75C2148C-3656-4d8a-846D-0CAE99AB6FF7"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
	...
	wire [0:0] tmpOE__SSR_1_net;
	wire [0:0] tmpFB_0__SSR_1_net;
	wire [0:0] tmpIO_0__SSR_1_net;
	wire [0:0] tmpINTERRUPT_0__SSR_1_net;
	electrical [0:0] tmpSIOVREF__SSR_1_net;

	cy_psoc3_pins_v1_10
		#(.id("2a2148c3-03e3-4311-84d7-2bac559c8fed"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		SSR_1
		 (.oe(tmpOE__SSR_1_net),
		  .y({Net_1609}),
		  .fb({tmpFB_0__SSR_1_net[0:0]}),
		  .io({tmpIO_0__SSR_1_net[0:0]}),
		  .siovref(tmpSIOVREF__SSR_1_net),
		  .interrupt({tmpINTERRUPT_0__SSR_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SSR_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("2315ee90-255e-4d58-a528-69529d756f1b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b824b540-0eb9-4269-bb94-805b9a3098d3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("f77ff006-2665-4d6d-a8e6-5e192c4177f2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fd627867-1083-4e60-9958-ced617dbd29d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("838fd1ef-910e-4f03-918b-2f5c280789b9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0413ef8e-2d81-42f1-bfaf-570037be66ab"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4b3306c6-ae00-4150-88c8-1b355defbcc4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("73c85348-d282-431e-af7a-bbebaade27b1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b7f353e1-4452-41b1-bc54-618ef04f87de"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4bbf51c8-5be1-4948-a020-8ff5ae0fab2d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("48986d71-43b0-4890-845c-1ea6f8eab7ad"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("bf05e984-1c0b-4503-b9a7-3a9d2739789a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("236f00c3-c931-4af9-b30e-4e98021510b3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0cbdf295-9556-481e-ab34-35449d8f17cc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("adfcf839-48b6-49eb-b8e0-ad909b80af82"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4e4c1b74-47cd-493a-9c3d-9ae346e0b2b8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("41d080fd-9401-4543-afbd-dfe11b3971f8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("84be2436-7fe5-4a51-aeb5-07cc88d60ac7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0e73f2d0-b77a-407e-acaa-5bd72290fd96"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("87893b7f-610e-48da-99ce-a5287464420b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ec15ddd7-74f5-4792-aab0-15ba1f72044f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e0afcb96-8efd-4ec5-bf0c-5c4999e1eed0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8a8e4bd4-5cdb-4142-a8d9-9b1bed51093c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("605ae7e6-44dd-4fc1-a09a-8f90f338a9a7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("cfdb6cb9-8e1d-4eb8-99eb-63b60d0cdd24"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_26_net;
	wire [0:0] tmpFB_0__Pin_26_net;
	wire [0:0] tmpIO_0__Pin_26_net;
	wire [0:0] tmpINTERRUPT_0__Pin_26_net;
	electrical [0:0] tmpSIOVREF__Pin_26_net;

	cy_psoc3_pins_v1_10
		#(.id("f50c9aad-aa86-4370-8688-77f19b44f9ba"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_26
		 (.oe(tmpOE__Pin_26_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_26_net[0:0]}),
		  .io({tmpIO_0__Pin_26_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_26_net),
		  .interrupt({tmpINTERRUPT_0__Pin_26_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_26_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

// ======================================================================
// CamaraClimatica.v generated from TopDesign.cysch
// 11/05/2020 at 13:22
...
// ADC_SAR_SEQ_v2_10(ADC_Clock_Frequency=1000000, Adjust=1, ClockSource=0, InputRange=1, NumChannels=3, Reference=0, Resolution=12, rm_int=false, SampleMode=0, SamplePrecharge=4, SampleRate=62500, SampleRate_def=631579, VrefValue=2.5, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_SEQ_v2_10, CY_CONFIG_TITLE=ADC_SAR, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR, CY_INSTANCE_SHORT_NAME=ADC_SAR, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=ADC_SAR, )
module ADC_SAR_SEQ_v2_10_3 (
	...
	cy_clock_v1_0
		#(.id("3420e7b7-7ee4-4198-b83f-5ec669e68646/9725d809-97e7-404e-b621-dfdbe78d0ca9"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	cy_clock_v1_0
		#(.id("3420e7b7-7ee4-4198-b83f-5ec669e68646/3d23b625-9a71-4c05-baf4-2f904356009b"),
...
module I2C_v3_50_4 (
	...
	cy_clock_v1_0
		#(.id("a43001be-8318-4047-9d4c-ff7fdb0a3441/5ece924d-20ba-480e-9102-bc082dcdd926"),
		  .source_clock_id("75C2148C-3656-4d8a-846D-0CAE99AB6FF7"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
...
// IDAC8_v2_0(Current=1000, Data_Source=0, Hardware_Enable=false, IDAC_Range=8, IDAC_Speed=2, Initial_Value=125, Polarity=0, Strobe_Mode=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=IDAC8_v2_0, CY_CONFIG_TITLE=IDAC, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=IDAC, CY_INSTANCE_SHORT_NAME=IDAC, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.3, INSTANCE_NAME=IDAC, )
module IDAC8_v2_0_6 (
    strobe,
    data,
    iOut,
...
module ADC_DelSig_v3_20_7 (
	...
	cy_clock_v1_0
		#(.id("94bf4929-1968-44c4-94fa-c20817854173/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("94bf4929-1968-44c4-94fa-c20817854173/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("372300819.061802"),
		  .is_direct(0),
		  .is_digital(0))
		theACLK
		 (.clock_out(Net_250));
...
module top ;
	...
	wire [0:0] tmpOE__LCD1_net;
	wire [0:0] tmpFB_0__LCD1_net;
	wire [0:0] tmpIO_0__LCD1_net;
	wire [0:0] tmpINTERRUPT_0__LCD1_net;
	electrical [0:0] tmpSIOVREF__LCD1_net;
	...
	cy_psoc3_pins_v1_10
		...
		LCD1
		 (.oe(tmpOE__LCD1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LCD1_net[0:0]}),
		  .io({tmpIO_0__LCD1_net[0:0]}),
		  .siovref(tmpSIOVREF__LCD1_net),
		  .interrupt({tmpINTERRUPT_0__LCD1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LCD1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__CR5_net;
	wire [0:0] tmpFB_0__CR5_net;
	wire [0:0] tmpIO_0__CR5_net;
	wire [0:0] tmpINTERRUPT_0__CR5_net;
	electrical [0:0] tmpSIOVREF__CR5_net;
	...
	cy_psoc3_pins_v1_10
		...
		CR5
		 (.oe(tmpOE__CR5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CR5_net[0:0]}),
		  .io({tmpIO_0__CR5_net[0:0]}),
		  .siovref(tmpSIOVREF__CR5_net),
		  .interrupt({tmpINTERRUPT_0__CR5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CR5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__CR4_net;
	wire [0:0] tmpFB_0__CR4_net;
	wire [0:0] tmpIO_0__CR4_net;
	wire [0:0] tmpINTERRUPT_0__CR4_net;
	electrical [0:0] tmpSIOVREF__CR4_net;
	...
	cy_psoc3_pins_v1_10
		...
		CR4
		 (.oe(tmpOE__CR4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CR4_net[0:0]}),
		  .io({tmpIO_0__CR4_net[0:0]}),
		  .siovref(tmpSIOVREF__CR4_net),
		  .interrupt({tmpINTERRUPT_0__CR4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CR4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SSR_net;
	wire [0:0] tmpFB_0__SSR_net;
	wire [0:0] tmpIO_0__SSR_net;
	wire [0:0] tmpINTERRUPT_0__SSR_net;
	electrical [0:0] tmpSIOVREF__SSR_net;
	...
	cy_psoc3_pins_v1_10
		...
		SSR
		 (.oe(tmpOE__SSR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SSR_net[0:0]}),
		  .io({tmpIO_0__SSR_net[0:0]}),
		  .siovref(tmpSIOVREF__SSR_net),
		  .interrupt({tmpINTERRUPT_0__SSR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SSR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DOOR_net;
	wire [0:0] tmpFB_0__DOOR_net;
	wire [0:0] tmpIO_0__DOOR_net;
	wire [0:0] tmpINTERRUPT_0__DOOR_net;
	electrical [0:0] tmpSIOVREF__DOOR_net;
	...
	cy_psoc3_pins_v1_10
		...
		DOOR
		 (.oe(tmpOE__DOOR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DOOR_net[0:0]}),
		  .io({tmpIO_0__DOOR_net[0:0]}),
		  .siovref(tmpSIOVREF__DOOR_net),
		  .interrupt({tmpINTERRUPT_0__DOOR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DOOR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LCD2_net;
	wire [0:0] tmpFB_0__LCD2_net;
	wire [0:0] tmpIO_0__LCD2_net;
	wire [0:0] tmpINTERRUPT_0__LCD2_net;
	electrical [0:0] tmpSIOVREF__LCD2_net;
	...
	cy_psoc3_pins_v1_10
		...
		LCD2
		 (.oe(tmpOE__LCD2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LCD2_net[0:0]}),
		  .io({tmpIO_0__LCD2_net[0:0]}),
		  .siovref(tmpSIOVREF__LCD2_net),
		  .interrupt({tmpINTERRUPT_0__LCD2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LCD2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ADC_SAR_SEQ_v2_10_3 ADC_SAR (
        .soc(1'b0),
        .aclk(1'b0),
        .sdone(Net_993),
        .eoc(Net_994),
    ...
    cy_annotation_universal_v1_0 Rw3 (
        .connect({
            Net_748,
            Net_966
        })
    );
    defparam Rw3.comp_name = "Resistor_v1_0";
    defparam Rw3.port_names = "T1, T2";
    defparam Rw3.width = 2;

    cy_annotation_universal_v1_0 Rw1 (
        .connect({
            Net_735,
            Net_730
        })
    );
    defparam Rw1.comp_name = "Resistor_v1_0";
    defparam Rw1.port_names = "T1, T2";
    defparam Rw1.width = 2;

    cy_annotation_universal_v1_0 Rw4 (
        .connect({
            Net_1112,
            Net_748
        })
    );
    defparam Rw4.comp_name = "Resistor_v1_0";
    defparam Rw4.port_names = "T1, T2";
    defparam Rw4.width = 2;
    ...
    cy_annotation_universal_v1_0 Rw3_1 (
        .connect({
            Net_1095,
            Net_1097
        })
    );
    defparam Rw3_1.comp_name = "Resistor_v1_0";
    defparam Rw3_1.port_names = "T1, T2";
    defparam Rw3_1.width = 2;
	...
	wire [0:0] tmpOE__CR2_net;
	wire [0:0] tmpFB_0__CR2_net;
	wire [0:0] tmpIO_0__CR2_net;
	wire [0:0] tmpINTERRUPT_0__CR2_net;
	electrical [0:0] tmpSIOVREF__CR2_net;
	...
	cy_psoc3_pins_v1_10
		...
		CR2
		 (.oe(tmpOE__CR2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CR2_net[0:0]}),
		  .io({tmpIO_0__CR2_net[0:0]}),
		  .siovref(tmpSIOVREF__CR2_net),
		  .interrupt({tmpINTERRUPT_0__CR2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CR2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("a720e8d3-22b1-43b3-9dd9-029e48b56c4b"),
		  .source_clock_id("75C2148C-3656-4d8a-846D-0CAE99AB6FF7"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
    ...
    cy_annotation_universal_v1_0 RTD_PT100_1 (
        .connect({
            Net_1094,
            Net_1095
        })
    );
    defparam RTD_PT100_1.comp_name = "Thermistor_v1_0";
    defparam RTD_PT100_1.port_names = "T1, T2";
    defparam RTD_PT100_1.width = 2;
	...
	wire [0:0] tmpOE__CR1_net;
	wire [0:0] tmpFB_0__CR1_net;
	wire [0:0] tmpIO_0__CR1_net;
	wire [0:0] tmpINTERRUPT_0__CR1_net;
	electrical [0:0] tmpSIOVREF__CR1_net;
	...
	cy_psoc3_pins_v1_10
		...
		CR1
		 (.oe(tmpOE__CR1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CR1_net[0:0]}),
		  .io({tmpIO_0__CR1_net[0:0]}),
		  .siovref(tmpSIOVREF__CR1_net),
		  .interrupt({tmpINTERRUPT_0__CR1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CR1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    cy_annotation_universal_v1_0 Rw2 (
        .connect({
            Net_735,
            Net_733
        })
    );
    defparam Rw2.comp_name = "Resistor_v1_0";
    defparam Rw2.port_names = "T1, T2";
    defparam Rw2.width = 2;

    cy_annotation_universal_v1_0 RTD_PT100 (
        .connect({
            Net_735,
            Net_748
        })
    );
    defparam RTD_PT100.comp_name = "Thermistor_v1_0";
    defparam RTD_PT100.port_names = "T1, T2";
    defparam RTD_PT100.width = 2;
    ...
    defparam CurrentMux.muxin_width = 3;
    defparam CurrentMux.init_mux_sel = 3'h0;
	...
	wire [0:0] tmpOE__RefRes_Current_net;
	wire [0:0] tmpFB_0__RefRes_Current_net;
	wire [0:0] tmpIO_0__RefRes_Current_net;
	wire [0:0] tmpINTERRUPT_0__RefRes_Current_net;
	electrical [0:0] tmpSIOVREF__RefRes_Current_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("cc3bcd7e-5dc0-48ea-9bf6-6aa082be1ada"),
		  ...
		  .input_buffer_sel(2'b00))
		RefRes_Current
		 (.oe(tmpOE__RefRes_Current_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RefRes_Current_net[0:0]}),
		  .analog({Net_317}),
		  .io({tmpIO_0__RefRes_Current_net[0:0]}),
		  .siovref(tmpSIOVREF__RefRes_Current_net),
		  .interrupt({tmpINTERRUPT_0__RefRes_Current_net[0:0]}),
		  .annotation({Net_337}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__RefRes_Current_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam ADCMux_CYAMUXSIDE_A.muxin_width = 3;
    defparam ADCMux_CYAMUXSIDE_A.init_mux_sel = 3'h0;
    ...
    defparam ADCMux_CYAMUXSIDE_B.muxin_width = 3;
    defparam ADCMux_CYAMUXSIDE_B.init_mux_sel = 3'h0;
	...
	wire [0:0] tmpOE__RefRes_Negative_net;
	wire [0:0] tmpFB_0__RefRes_Negative_net;
	wire [0:0] tmpIO_0__RefRes_Negative_net;
	wire [0:0] tmpINTERRUPT_0__RefRes_Negative_net;
	electrical [0:0] tmpSIOVREF__RefRes_Negative_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e6a78dda-4163-44a3-ba1a-0ebd2091c811"),
		  ...
		  .input_buffer_sel(2'b00))
		RefRes_Negative
		 (.oe(tmpOE__RefRes_Negative_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RefRes_Negative_net[0:0]}),
		  .analog({Net_1118}),
		  .io({tmpIO_0__RefRes_Negative_net[0:0]}),
		  .siovref(tmpSIOVREF__RefRes_Negative_net),
		  .interrupt({tmpINTERRUPT_0__RefRes_Negative_net[0:0]}),
		  .annotation({Net_273}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__RefRes_Negative_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RefRes_Positive_net;
	wire [0:0] tmpFB_0__RefRes_Positive_net;
	wire [0:0] tmpIO_0__RefRes_Positive_net;
	wire [0:0] tmpINTERRUPT_0__RefRes_Positive_net;
	electrical [0:0] tmpSIOVREF__RefRes_Positive_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("a0dc62ab-f805-4720-965d-17dae5646d0d"),
		  ...
		  .input_buffer_sel(2'b00))
		RefRes_Positive
		 (.oe(tmpOE__RefRes_Positive_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RefRes_Positive_net[0:0]}),
		  .analog({Net_186}),
		  .io({tmpIO_0__RefRes_Positive_net[0:0]}),
		  .siovref(tmpSIOVREF__RefRes_Positive_net),
		  .interrupt({tmpINTERRUPT_0__RefRes_Positive_net[0:0]}),
		  .annotation({Net_337}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__RefRes_Positive_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    cy_annotation_universal_v1_0 Rw2_1 (
        .connect({
            Net_1094,
            Net_1096
        })
    );
    defparam Rw2_1.comp_name = "Resistor_v1_0";
    defparam Rw2_1.port_names = "T1, T2";
    defparam Rw2_1.width = 2;

	wire [0:0] tmpOE__CR3_net;
	wire [0:0] tmpFB_0__CR3_net;
	wire [0:0] tmpIO_0__CR3_net;
	wire [0:0] tmpINTERRUPT_0__CR3_net;
	electrical [0:0] tmpSIOVREF__CR3_net;
	...
	cy_psoc3_pins_v1_10
		...
		CR3
		 (.oe(tmpOE__CR3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CR3_net[0:0]}),
		  .io({tmpIO_0__CR3_net[0:0]}),
		  .siovref(tmpSIOVREF__CR3_net),
		  .interrupt({tmpINTERRUPT_0__CR3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CR3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    cy_annotation_universal_v1_0 Rw1_1 (
        .connect({
            Net_1094,
            Net_1098
        })
    );
    defparam Rw1_1.comp_name = "Resistor_v1_0";
    defparam Rw1_1.port_names = "T1, T2";
    defparam Rw1_1.width = 2;

    cy_annotation_universal_v1_0 Rw4_1 (
        .connect({
            Net_1099,
            Net_1095
        })
    );
    defparam Rw4_1.comp_name = "Resistor_v1_0";
    defparam Rw4_1.port_names = "T1, T2";
    defparam Rw4_1.width = 2;
	...
	wire [0:0] tmpOE__RTD_Negative_1_net;
	wire [0:0] tmpFB_0__RTD_Negative_1_net;
	wire [0:0] tmpIO_0__RTD_Negative_1_net;
	wire [0:0] tmpINTERRUPT_0__RTD_Negative_1_net;
	electrical [0:0] tmpSIOVREF__RTD_Negative_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("962f3522-5598-46ee-a4b5-f620da3739d8"),
		  ...
		  .input_buffer_sel(2'b00))
		RTD_Negative_1
		 (.oe(tmpOE__RTD_Negative_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RTD_Negative_1_net[0:0]}),
		  .analog({Net_1120}),
		  .io({tmpIO_0__RTD_Negative_1_net[0:0]}),
		  .siovref(tmpSIOVREF__RTD_Negative_1_net),
		  .interrupt({tmpINTERRUPT_0__RTD_Negative_1_net[0:0]}),
		  .annotation({Net_1119}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__RTD_Negative_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RTD_Positive_1_net;
	wire [0:0] tmpFB_0__RTD_Positive_1_net;
	wire [0:0] tmpIO_0__RTD_Positive_1_net;
	wire [0:0] tmpINTERRUPT_0__RTD_Positive_1_net;
	electrical [0:0] tmpSIOVREF__RTD_Positive_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("3bf1539e-1d78-4706-97ff-365424c9a088"),
		  ...
		  .input_buffer_sel(2'b00))
		RTD_Positive_1
		 (.oe(tmpOE__RTD_Positive_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RTD_Positive_1_net[0:0]}),
		  .analog({Net_185}),
		  .io({tmpIO_0__RTD_Positive_1_net[0:0]}),
		  .siovref(tmpSIOVREF__RTD_Positive_1_net),
		  .interrupt({tmpINTERRUPT_0__RTD_Positive_1_net[0:0]}),
		  .annotation({Net_1121}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__RTD_Positive_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__RTD_Current_1_net;
	wire [0:0] tmpFB_0__RTD_Current_1_net;
	wire [0:0] tmpIO_0__RTD_Current_1_net;
	wire [0:0] tmpINTERRUPT_0__RTD_Current_1_net;
	electrical [0:0] tmpSIOVREF__RTD_Current_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8ebee04e-8281-4af5-a7d0-21795d758ca9"),
		  ...
		  .input_buffer_sel(2'b00))
		RTD_Current_1
		 (.oe(tmpOE__RTD_Current_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RTD_Current_1_net[0:0]}),
		  .analog({Net_1125}),
		  .io({tmpIO_0__RTD_Current_1_net[0:0]}),
		  .siovref(tmpSIOVREF__RTD_Current_1_net),
		  .interrupt({tmpINTERRUPT_0__RTD_Current_1_net[0:0]}),
		  .annotation({Net_1126}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__RTD_Current_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DS1302_IO_PIN_net;
	wire [0:0] tmpFB_0__DS1302_IO_PIN_net;
	wire [0:0] tmpIO_0__DS1302_IO_PIN_net;
	wire [0:0] tmpINTERRUPT_0__DS1302_IO_PIN_net;
	electrical [0:0] tmpSIOVREF__DS1302_IO_PIN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("b3018da6-65cb-44d2-a7aa-c95889ab96e5"),
		  ...
		  .input_buffer_sel(2'b00))
		DS1302_IO_PIN
		 (.oe(tmpOE__DS1302_IO_PIN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DS1302_IO_PIN_net[0:0]}),
		  .io({tmpIO_0__DS1302_IO_PIN_net[0:0]}),
		  .siovref(tmpSIOVREF__DS1302_IO_PIN_net),
		  .interrupt({tmpINTERRUPT_0__DS1302_IO_PIN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DS1302_IO_PIN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DS1302_SCLK_PIN_net;
	wire [0:0] tmpFB_0__DS1302_SCLK_PIN_net;
	wire [0:0] tmpIO_0__DS1302_SCLK_PIN_net;
	wire [0:0] tmpINTERRUPT_0__DS1302_SCLK_PIN_net;
	electrical [0:0] tmpSIOVREF__DS1302_SCLK_PIN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("ff83744d-0942-4605-8def-812b24722981"),
		  ...
		  .input_buffer_sel(2'b00))
		DS1302_SCLK_PIN
		 (.oe(tmpOE__DS1302_SCLK_PIN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DS1302_SCLK_PIN_net[0:0]}),
		  .io({tmpIO_0__DS1302_SCLK_PIN_net[0:0]}),
		  .siovref(tmpSIOVREF__DS1302_SCLK_PIN_net),
		  .interrupt({tmpINTERRUPT_0__DS1302_SCLK_PIN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DS1302_SCLK_PIN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__DS1302_CE_PIN_net;
	wire [0:0] tmpFB_0__DS1302_CE_PIN_net;
	wire [0:0] tmpIO_0__DS1302_CE_PIN_net;
	wire [0:0] tmpINTERRUPT_0__DS1302_CE_PIN_net;
	electrical [0:0] tmpSIOVREF__DS1302_CE_PIN_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("4802c413-cdaa-4ed5-8d5a-68ab274c08d6"),
		  ...
		  .input_buffer_sel(2'b00))
		DS1302_CE_PIN
		 (.oe(tmpOE__DS1302_CE_PIN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DS1302_CE_PIN_net[0:0]}),
		  .io({tmpIO_0__DS1302_CE_PIN_net[0:0]}),
		  .siovref(tmpSIOVREF__DS1302_CE_PIN_net),
		  .interrupt({tmpINTERRUPT_0__DS1302_CE_PIN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DS1302_CE_PIN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__LEVEL_net;
	wire [0:0] tmpFB_0__LEVEL_net;
	wire [0:0] tmpIO_0__LEVEL_net;
	wire [0:0] tmpINTERRUPT_0__LEVEL_net;
	electrical [0:0] tmpSIOVREF__LEVEL_net;
	...
	cy_psoc3_pins_v1_10
		...
		LEVEL
		 (.oe(tmpOE__LEVEL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LEVEL_net[0:0]}),
		  .io({tmpIO_0__LEVEL_net[0:0]}),
		  .siovref(tmpSIOVREF__LEVEL_net),
		  .interrupt({tmpINTERRUPT_0__LEVEL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LEVEL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__TERM_net;
	wire [0:0] tmpFB_0__TERM_net;
	wire [0:0] tmpIO_0__TERM_net;
	wire [0:0] tmpINTERRUPT_0__TERM_net;
	electrical [0:0] tmpSIOVREF__TERM_net;
	...
	cy_psoc3_pins_v1_10
		...
		TERM
		 (.oe(tmpOE__TERM_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__TERM_net[0:0]}),
		  .io({tmpIO_0__TERM_net[0:0]}),
		  .siovref(tmpSIOVREF__TERM_net),
		  .interrupt({tmpINTERRUPT_0__TERM_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__TERM_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__HUMEDAD_net;
	wire [0:0] tmpFB_0__HUMEDAD_net;
	wire [0:0] tmpIO_0__HUMEDAD_net;
	wire [0:0] tmpINTERRUPT_0__HUMEDAD_net;
	electrical [0:0] tmpSIOVREF__HUMEDAD_net;

	cy_psoc3_pins_v1_10
		#(.id("22d3030a-0624-4dd1-bf48-3d92ca42d8a1"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		HUMEDAD
		 (.oe(tmpOE__HUMEDAD_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__HUMEDAD_net[0:0]}),
		  .analog({Net_1212}),
		  .io({tmpIO_0__HUMEDAD_net[0:0]}),
		  .siovref(tmpSIOVREF__HUMEDAD_net),
		  .interrupt({tmpINTERRUPT_0__HUMEDAD_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__HUMEDAD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__NTC_net;
	wire [0:0] tmpFB_0__NTC_net;
	wire [0:0] tmpIO_0__NTC_net;
	wire [0:0] tmpINTERRUPT_0__NTC_net;
	electrical [0:0] tmpSIOVREF__NTC_net;

	cy_psoc3_pins_v1_10
		#(.id("bffc712c-aefc-4d18-ba04-722e38d3e883"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		NTC
		 (.oe(tmpOE__NTC_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__NTC_net[0:0]}),
		  .analog({Net_998}),
		  .io({tmpIO_0__NTC_net[0:0]}),
		  .siovref(tmpSIOVREF__NTC_net),
		  .interrupt({tmpINTERRUPT_0__NTC_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__NTC_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CR6_net;
	wire [0:0] tmpFB_0__CR6_net;
	wire [0:0] tmpIO_0__CR6_net;
	wire [0:0] tmpINTERRUPT_0__CR6_net;
	electrical [0:0] tmpSIOVREF__CR6_net;
	...
	cy_psoc3_pins_v1_10
		...
		CR6
		 (.oe(tmpOE__CR6_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CR6_net[0:0]}),
		  .io({tmpIO_0__CR6_net[0:0]}),
		  .siovref(tmpSIOVREF__CR6_net),
		  .interrupt({tmpINTERRUPT_0__CR6_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CR6_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CR7_net;
	wire [0:0] tmpFB_0__CR7_net;
	wire [0:0] tmpIO_0__CR7_net;
	wire [0:0] tmpINTERRUPT_0__CR7_net;
	electrical [0:0] tmpSIOVREF__CR7_net;
	...
	cy_psoc3_pins_v1_10
		...
		CR7
		 (.oe(tmpOE__CR7_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CR7_net[0:0]}),
		  .io({tmpIO_0__CR7_net[0:0]}),
		  .siovref(tmpSIOVREF__CR7_net),
		  .interrupt({tmpINTERRUPT_0__CR7_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CR7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__CR8_net;
	wire [0:0] tmpFB_0__CR8_net;
	wire [0:0] tmpIO_0__CR8_net;
	wire [0:0] tmpINTERRUPT_0__CR8_net;
	electrical [0:0] tmpSIOVREF__CR8_net;
	...
	cy_psoc3_pins_v1_10
		...
		CR8
		 (.oe(tmpOE__CR8_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CR8_net[0:0]}),
		  .io({tmpIO_0__CR8_net[0:0]}),
		  .siovref(tmpSIOVREF__CR8_net),
		  .interrupt({tmpINTERRUPT_0__CR8_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CR8_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

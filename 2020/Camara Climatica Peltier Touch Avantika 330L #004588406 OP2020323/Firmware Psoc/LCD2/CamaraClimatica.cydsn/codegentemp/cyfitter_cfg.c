...
#define BS_IOPORT_7_VAL ((const uint8 CYFAR *)0x480009D8u)
...
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x48000A04u)

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)0x48000A10u)

/* IOPINS0_3 Address: CYREG_PRT3_DR Size (bytes): 10 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000A18u)

/* IOPINS0_4 Address: CYREG_PRT4_DM0 Size (bytes): 8 */
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x48000A24u)

/* IOPINS0_5 Address: CYREG_PRT5_DM0 Size (bytes): 8 */
#define BS_IOPINS0_5_VAL ((const uint8 CYFAR *)0x48000A2Cu)

/* IOPINS0_6 Address: CYREG_PRT6_DR Size (bytes): 10 */
#define BS_IOPINS0_6_VAL ((const uint8 CYFAR *)0x48000A34u)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x48000A40u)

/* PHUB_CFGMEM1 Address: CYREG_PHUB_CFGMEM1_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM1_VAL ((const uint8 CYFAR *)0x48000A44u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_SAR1_SW0, 0x4Cu);
...
uint8 CYXDATA * const CYCODE ADCMux_CYAMUXSIDE_A__addrTable[6] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE ADCMux_CYAMUXSIDE_A__maskTable[6] = {
	0x10u, 0x10u, 
	0x02u, 0x20u, 
	0x80u, 0x10u, 
};
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE ADCMux_CYAMUXSIDE_B__addrTable[6] = {
	(uint8 CYXDATA *)CYREG_PRT3_AG, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_OPAMP3_SW, (uint8 CYXDATA *)CYREG_OPAMP3_MX, 
	(uint8 CYXDATA *)CYREG_DAC0_SW3, (uint8 CYXDATA *)CYREG_DSM0_SW4, 
};

/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE ADCMux_CYAMUXSIDE_B__maskTable[6] = {
	0x08u, 0x00u, 
	0x02u, 0x20u, 
	0x80u, 0x02u, 
};
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE CurrentMux__addrTable[6] = {
	(uint8 CYXDATA *)CYREG_PRT3_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT3_AMUX, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT4_AMUX, (uint8 CYXDATA *)CYREG_BUS_SW3, 
};

/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE CurrentMux__maskTable[6] = {
	0x20u, 0x00u, 
	0x01u, 0x00u, 
	0x04u, 0x01u, 
};

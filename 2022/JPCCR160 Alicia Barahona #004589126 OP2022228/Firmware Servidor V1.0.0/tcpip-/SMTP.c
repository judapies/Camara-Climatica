						...
						switch(PutHeadersState)
						{
							...
							case PUTHEADERS_FROM:
								if(SMTPClient.ROMPointers.From)
								{
									...
									memcpypgm2ram(&c,SMTPClient.From.szROM,1);
									if(c == 0u)
							...
							case PUTHEADERS_TO:
								if(SMTPClient.ROMPointers.To)
								{
									...
									memcpypgm2ram(&c,SMTPClient.To.szROM,1);
									if(c == 0u)
							...
							case PUTHEADERS_CC:
								if(SMTPClient.ROMPointers.CC)
								{
									...
									memcpypgm2ram(&c,SMTPClient.CC.szROM,1);
									if(c == 0u)
							...
							case PUTHEADERS_SUBJECT:
								if(SMTPClient.ROMPointers.Subject)
								{
									...
									memcpypgm2ram(&c,SMTPClient.Subject.szROM,1);
									if(c == 0u)
							...
							case PUTHEADERS_OTHER:
								if(SMTPClient.ROMPointers.OtherHeaders)
								{
									...
									memcpypgm2ram(&c,SMTPClient.OtherHeaders.szROM,1);
									if(c == 0u)

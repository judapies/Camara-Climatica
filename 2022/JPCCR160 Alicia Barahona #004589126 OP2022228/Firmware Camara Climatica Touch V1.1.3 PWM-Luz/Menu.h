...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------
    if(Menu==18){ //Menu de Rampas
        ...
        if(Rx_Buffer[4]==0x80){//80, Iniciar
            if(!flagRampa){
                if(Segmentos>0){
                  if(!inicioControlH && !inicioControlT){
                    rampa=OFF;
                    flagRampa=ON;
                    ...
                    Rx_Buffer[4]=0x00;  
                    Rx_Buffer2[4]=0x00; 
                    EEPROM_WriteByte(1,43);delay_ms(20);
                  }
                }else{

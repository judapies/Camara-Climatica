...
short desconectoTemperatura=OFF,desconectoHumedad=OFF,graficaa=OFF,flagMotor=OFF,Humidificar=0,dehumidificador=0,humidificador=0,flagHumedad=0;
short flagSobrepasoHumedad=0,estadoVentilador=0,flagTem=0,flagHum=0,alarmaT=0,alarmaH=0,entroRampa=OFF,Controlando=OFF,controlaH=0;
int8 T1Humedad=0,T2Humedad=0,T3Humedad=0,tDisplay=0,mediaLuces=0,conteoAlarma=0,ajustaIP=0;
int16 tdehumidificador,thumidificador,data=0,data2=0,datacount=0,pwm2=0,tCongela=0,tllenado=0,tCalentamiento=0,thumidificacion=0;

int8 Vel1=0,SetpointH=0,controlL=0,alarma=0,nivelBajo=0,nivelAlto=0,bomba=0;  
...
int16 derivativo_ant=0,T1=0,T3=0,tmp3=0,tSobrepaso=0,i=0,n=0,tDisplayHumedad=0,tDefrost2=0,pwm=0,tpwm1=0,tpwm2=0,TcH=0,Tph=0;
...
float Ganancia=0,errorH=0,TpulsoH=0.0,TcicloH=0.0;
...
float Prom=0,Prom2=0,V0=0,V1=0,Temperature=0,TemperaturaPt1002=0.0,Pt=0.0,Pt2=0.0,TiempoRampa=0,Tam=0,RH2=0,Histeresis=0.2;
               ...
               SendDataDisplay();
                ...
                if(flagRampa){
                    ...
                    if(flagControlH){ 
                        ...
                        SendDataDisplay();
                        tllenado=0;
                        DC4_off;//Deshumidificador
                        DC5_off;//Humidificador

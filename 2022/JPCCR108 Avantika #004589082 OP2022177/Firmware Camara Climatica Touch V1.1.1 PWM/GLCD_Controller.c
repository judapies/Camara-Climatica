...
short flagSobrepasoHumedad=0,estadoVentilador=0,flagTem=0,flagHum=0,alarmaT=0,alarmaH=0,entroRampa=OFF,Controlando=OFF,controlaH=0,calculaMediana=OFF;
...
int16 TiempoActual=0,MinutosActual=0,HorasActual=0,Tiempo=0,tPregunta=0,tControlH=0;
